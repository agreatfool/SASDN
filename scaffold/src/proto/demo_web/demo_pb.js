...
goog.exportSymbol('proto.demo.GetDemoOrderResponse', null, global);
 ...
 * @constructor
 */
proto.demo.GetDemoOrderResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.demo.GetDemoOrderResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.demo.GetDemoOrderResponse.displayName = 'proto.demo.GetDemoOrderResponse';
}
 ...
 * @return {!Object}
 */
proto.demo.GetDemoOrderResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.demo.GetDemoOrderResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.demo.GetDemoOrderResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.demo.GetDemoOrderResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    orderId: jspb.Message.getFieldWithDefault(msg, 1, 0),
    orderContent: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.demo.GetDemoOrderResponse}
 */
proto.demo.GetDemoOrderResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.demo.GetDemoOrderResponse;
  return proto.demo.GetDemoOrderResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.demo.GetDemoOrderResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.demo.GetDemoOrderResponse}
 */
proto.demo.GetDemoOrderResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.demo.GetDemoOrderResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.demo.GetDemoOrderResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.demo.GetDemoOrderResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.demo.GetDemoOrderResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.demo.GetDemoOrderResponse.prototype.getOrderId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.demo.GetDemoOrderResponse.prototype.setOrderId = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * optional string order_content = 2;
 * @return {string}
 */
proto.demo.GetDemoOrderResponse.prototype.getOrderContent = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.demo.GetDemoOrderResponse.prototype.setOrderContent = function(value) {
  jspb.Message.setField(this, 2, value);
};
